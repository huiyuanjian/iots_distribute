...
public class KafkaUtils {
     ...
     * @param msg
     */
    public static void sendMsgToKafka(Message msg) {
        producer.send(new ProducerRecord<String, String>("test", "key",
                JSON.toJSONString(msg)));
        producer.send(new ProducerRecord<String, String>("test1", "key",
                JSON.toJSONString(msg)));
        producer.send(new ProducerRecord<String, String>("test2", "key",
                JSON.toJSONString(msg)));
    }
